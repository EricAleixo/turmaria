...
class TurmasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create turma" do
    assert_difference("Turma.count") do
      post turmas_url, params: { turma: { nome: @turma.nome, serie: @turma.serie, turno: @turma.turno } }
    end
  ...
  test "should update turma" do
    patch turma_url(@turma), params: { turma: { nome: @turma.nome, serie: @turma.serie, turno: @turma.turno } }
